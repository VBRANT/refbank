...
import de.uka.ipd.idaho.plugins.bibRefs.dataParsers.RisParser;
import de.uka.ipd.idaho.refBank.apps.webInterface.RefDataFormat.RefDataParserWrapper;

/**
 * Data format adapter for the EndNote RIS reference data format.
 * 
 * @author sautter
 */
public class RisDataFormat extends RefDataParserWrapper {
	public RisDataFormat() {
		super(new RisParser(), "ris", true);
	}
	/* (non-Javadoc)
