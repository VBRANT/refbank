...
import de.uka.ipd.idaho.plugins.bibRefs.dataParsers.BibTeXParser;
import de.uka.ipd.idaho.refBank.apps.webInterface.RefDataFormat.RefDataParserWrapper;

/**
 * Data format adapter for the BibTeX reference data format.
 * 
 * @author sautter
 */
public class BibTeXDataFormat extends RefDataParserWrapper {
	public BibTeXDataFormat() {
		super(new BibTeXParser(), "bib", true);
	}
	/* (non-Javadoc)
