...
import de.uka.ipd.idaho.plugins.bibRefs.dataParsers.EndNoteXmlParser;
import de.uka.ipd.idaho.refBank.apps.webInterface.RefDataFormat.RefDataParserWrapper;

/**
 * Data format adapter for the EndNote XML reference data format.
 * 
 * @author sautter
 */
public class EndNoteXmlDataFormat extends RefDataParserWrapper {
	public EndNoteXmlDataFormat() {
		super(new EndNoteXmlParser(), "xml", true);
	}
	/* (non-Javadoc)
